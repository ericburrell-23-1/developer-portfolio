    ...
    <div className="prof-exp">
      <div className="content-wrapper">
        <div className="pe-text">
          ...
          <p>
            As <i>Technical Solutions and Production Lead</i>, I actually have a
            lot of responsibilities here, given it's a local small business with
            a very small staff. However, I've looked for opportunities to use
            home-grown software to optimize production capabilities. <br />
            <br />
            ...
            (such as the{" "}
            <span className="ms-more-link" style={{ "padding-bottom": 0 }}>
